                            ...
                            <div className="review-form__column review-form__column--left">
                                <div className="review-form__field-group">
                                    ...
                                    <div className="review-form__date-grid">
                                        <input className="review-form__input" type="text" inputMode="numeric" placeholder="DD" />
                                        <input className="review-form__input" type="text" inputMode="numeric" placeholder="MM" />
                                        <input className="review-form__input" type="text" inputMode="numeric" placeholder="YYYY" />
                                    </div>
                                </div>
