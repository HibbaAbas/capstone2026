    ...
    <div className="filter-page ui-page">
      ...
      <main className="filter-content ui-container">
        ...
        <div className="filter-page__top-row">
          ...
          <button
            className="ghost-action ui-pill-button ui-pill-button--ghost"
            type="button"
          >
            Clear All
          </button>
        ...
        <div className="filter-page__bottom-row">
          <button
            className="apply-action ui-pill-button ui-pill-button--primary"
            type="button"
            onClick={() => navigate("/explore")}
          >
            Apply Filters and Return to Search
          </button>
          <button
            className="primary-action ui-pill-button ui-pill-button--primary"
            type="button"
          >
